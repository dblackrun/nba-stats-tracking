...
def test_get_tracking_shots_response_team():
    ...
    response_json = tracking_shots.get_tracking_shots_response(
        "team", season, season_type, close_def_dist=close_def_dist
    )
...
def test_get_tracking_shots_response_player():
    ...
    response_json = tracking_shots.get_tracking_shots_response(
        "player", season, season_type, shot_clock=shot_clock
    )
...
def test_get_tracking_shots_response_opponent():
    ...
    response_json = tracking_shots.get_tracking_shots_response(
        "opponent", season, season_type, dribbles=dribbles
    )
    assert len(response_json["resultSets"][0]["rowSet"]) == 30
...
def test_get_tracking_shots_response_invalid_entity_type():
    ...
    response_json = tracking_shots.get_tracking_shots_response(
        entity_type, season, season_type
    )
...
def test_generate_tracking_shot_game_logs():
    ...
    game_logs = tracking_shots.generate_tracking_shot_game_logs(
        "player", date, date, close_def_dists=[def_distance]
    )
    ...
    items1 = [
        {
            ...
            "PLAYER_LAST_TEAM_ID": 1610612754,
            "PLAYER_LAST_TEAM_ABBREVIATION": "IND",
            "AGE": 31.0,
            "GP": 76,
            "G": 55,
            "FGA_FREQUENCY": 0.147,
            ...
            "FG_PCT": 0.474,
            "EFG_PCT": 0.665,
            "FG2A_FREQUENCY": 0.026,
            "FG2M": 9,
            "FG2A": 17,
            "FG2_PCT": 0.529,
            "FG3A_FREQUENCY": 0.121,
            "FG3M": 37,
            "FG3A": 80,
            "FG3_PCT": 0.463,
            "OVERALL_FGA": 324,
        ...
        },
        {
            ...
            "PLAYER_LAST_TEAM_ID": 1610612737,
            "PLAYER_LAST_TEAM_ABBREVIATION": "ATL",
            "AGE": 21.0,
            "GP": 46,
            "G": 37,
            "FGA_FREQUENCY": 0.398,
            ...
            "FG_PCT": 0.33,
            "EFG_PCT": 0.495,
            "FG2A_FREQUENCY": 0.008,
            "FG2M": 0,
            "FG2A": 2,
            "FG2_PCT": 0.0,
            "FG3A_FREQUENCY": 0.389,
            "FG3M": 32,
            "FG3A": 95,
            "FG3_PCT": 0.337,
            "OVERALL_FGA": 324,
        ...
        },
        {
            ...
            "PLAYER_LAST_TEAM_ID": 1610612738,
            "PLAYER_LAST_TEAM_ABBREVIATION": "BOS",
            "AGE": 27.0,
            "GP": 67,
            "G": 50,
            "FGA_FREQUENCY": 0.077,
    ...
    items2 = [
        {
            ...
            "FG_PCT": 0.365,
            "EFG_PCT": 0.542,
            "FG2A_FREQUENCY": 0.003,
            "FG2M": 1,
            "FG2A": 2,
            "FG2_PCT": 0.5,
            "FG3A_FREQUENCY": 0.141,
            "FG3M": 34,
            "FG3A": 94,
            "FG3_PCT": 0.362,
            "OVERALL_FGA": 324,
        ...
        },
        {
            ...
            "PLAYER_LAST_TEAM_ID": 1610612743,
            "PLAYER_LAST_TEAM_ABBREVIATION": "DEN",
            "AGE": 28.0,
            "GP": 75,
            "G": 55,
            "FGA_FREQUENCY": 0.262,
...
def test_sum_tracking_shot_totals_team():
    items1 = [
        ...
        },
        {
            ...
            "FG_PCT": 0.424,
            "EFG_PCT": 0.607,
            "FG2A_FREQUENCY": 0.021,
            "FG2M": 86,
            "FG2A": 153,
            "FG2_PCT": 0.562,
            "FG3A_FREQUENCY": 0.183,
            "FG3M": 546,
            "FG3A": 1337,
            "FG3_PCT": 0.408,
            "OVERALL_FGA": 6326,
    ...
    items2 = [
        {
            ...
            "FG_PCT": 0.388,
            "EFG_PCT": 0.528,
            "FG2A_FREQUENCY": 0.023,
            "FG2M": 78,
            "FG2A": 167,
            "FG2_PCT": 0.467,
            "FG3A_FREQUENCY": 0.076,
            "FG3M": 202,
            "FG3A": 555,
            "FG3_PCT": 0.364,
            "OVERALL_FGA": 6324,
        ...
        },
        {
            ...
            "FG_PCT": 0.335,
            "EFG_PCT": 0.469,
            "FG2A_FREQUENCY": 0.014,
            "FG2M": 46,
            "FG2A": 105,
            "FG2_PCT": 0.438,
            "FG3A_FREQUENCY": 0.075,
            "FG3M": 180,
            "FG3A": 569,
            "FG3_PCT": 0.316,
            "OVERALL_FGA": 6326,
